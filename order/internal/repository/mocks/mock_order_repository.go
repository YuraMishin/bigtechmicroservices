...
func (_m *OrderRepository) GetOrder(ctx context.Context, orderUUID uuid.UUID) (model.Order, error) {
...
func (_c *OrderRepository_GetOrder_Call) Run(run func(ctx context.Context, orderUUID uuid.UUID)) *OrderRepository_GetOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
