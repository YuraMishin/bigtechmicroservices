...
func (_m *PaymentClient) PayOrder(ctx context.Context, orderUUID string, userUUID string, paymentMethod string) (order_v1.PayOrderRes, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (order_v1.PayOrderRes, error)); ok {
		return rf(ctx, orderUUID, userUUID, paymentMethod)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) order_v1.PayOrderRes); ok {
...
func (_c *PaymentClient_PayOrder_Call) Return(_a0 order_v1.PayOrderRes, _a1 error) *PaymentClient_PayOrder_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PaymentClient_PayOrder_Call) RunAndReturn(run func(context.Context, string, string, string) (order_v1.PayOrderRes, error)) *PaymentClient_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
