...
// Encode encodes OrderDtoStatus as json.
func (s OrderDtoStatus) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes OrderDtoStatus from json.
func (s *OrderDtoStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode OrderDtoStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OrderDtoStatus) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OrderDtoStatus) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
