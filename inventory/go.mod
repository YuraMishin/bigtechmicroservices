...
replace github.com/YuraMishin/bigtechmicroservices/platform => ../platform

require (
	github.com/YuraMishin/bigtechmicroservices/platform v0.0.0-00010101000000-000000000000
