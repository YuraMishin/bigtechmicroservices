...
import (
	...
	"github.com/YuraMishin/bigtechmicroservices/inventory/internal/app"
...
func gracefulShutdown() {
	ctx, cancel := context.WithTimeout(context.Background(), config.AppConfig().InventoryGRPC.ShutdownTimeout())
	defer cancel()
